...
const Gift = () => {
  return (
    <>
      ...
      <button className="uppercase bg-red-500 p-2 text-white border rounded-xl text-[14px] font-bold mb-16">
        Thêm thẻ mới
      </button>
          ...
          <div key={index}>
            ...
            <div>
              <div className="flex justify-between">
                <div className="flex">
                  <a href={`/gifts/${item.slug}`}>
                    <img src={item.url} alt="" className="w-[50px] h-[50px] object-cover border rounded-3xl" />
                  </a>
